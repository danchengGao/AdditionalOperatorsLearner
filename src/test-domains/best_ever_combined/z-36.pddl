...
(:action macro-2-3-968225084
    :parameters (?l1 - flevel ?l2 - flevel ?a - aircraft ?l - flevel)
    :precondition 
    (and
        (next ?l1 ?l2)
        (fuel-level ?a ?l)
...
(:action nonr-board-and-zoom-112
    :parameters (?p_0 - person ?a_0 - aircraft ?c_0 - city ?l1 - flevel ?l2 - flevel ?l3 - flevel)
    :precondition 
    (and
        (at ?p_0 ?c_0)
        (at ?a_0 ?c_0)
